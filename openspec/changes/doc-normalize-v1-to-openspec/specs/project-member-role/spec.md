...
### Requirement: 平台角色和项目成员授权必须分层

平台角色决定能进入哪些模块，项目成员配置决定能否进入某个项目以及能操作哪些范围，二者不得混成单一概念。
...
### Requirement: 项目成员必须支持阶段和专业等范围限定

项目成员授权必须至少支持项目、阶段、专业和单体等范围限定，以满足细粒度协作分工。
...
### Requirement: 成员配置必须支持系统角色和业务身份并存

正式成员配置必须同时承载系统角色和业务身份语义，避免只有权限没有业务语境。
...
### Requirement: 项目负责人必须自动纳入项目成员体系

项目负责人不能游离于项目成员体系之外，项目创建或负责人切换后必须体现在项目成员配置中。
...
### Requirement: 审核人与编制人必须允许分离配置

成员体系必须支持审核人与编制人分离配置，以承接后续审核流和审编分离要求。
